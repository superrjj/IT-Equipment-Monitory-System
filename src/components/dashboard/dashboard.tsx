        ...
        >
          ...
          >
            ...
            <section style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              ...
              >
                <h2 style={{ fontSize: 14, fontWeight: 600, color: "#111827", marginBottom: "0.8rem" }}>
                  Equipment per department
                </h2>
                <table
                  style={{
                ...
                >
                  <thead>
                    <tr style={{ textAlign: "left", borderBottom: "1px solid #e5e7eb" }}>
                      <th style={{ padding: "0.55rem 0.35rem 0.55rem 0", fontWeight: 500, color: "#6b7280" }}>Department</th>
                      <th style={{ padding: "0.55rem 0.35rem", fontWeight: 500, color: "#6b7280" }}>Total</th>
                      <th style={{ padding: "0.55rem 0.35rem", fontWeight: 500, color: "#6b7280" }}>Defective</th>
                      <th style={{ padding: "0.55rem 0 0.55rem 0.35rem", fontWeight: 500, color: "#6b7280" }}>Under repair</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      { name: "City Health Office", total: 40, defective: 3, repair: 2 },
                      { name: "CENRO", total: 18, defective: 1, repair: 0 },
                      { name: "CDRRMO", total: 22, defective: 2, repair: 1 },
                      { name: "POSO", total: 24, defective: 2, repair: 2 },
                    ].map((row) => (
                      <tr key={row.name} style={{ borderBottom: "1px solid #f3f4f6" }}>
                        <td style={{ padding: "0.55rem 0.35rem 0.55rem 0", fontWeight: 500 }}>{row.name}</td>
                        ...
                        <td style={{ padding: "0.55rem 0 0.55rem 0.35rem", color: "#eab308", fontWeight: 500 }}>{row.repair}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            {/* Right column: recent repairs only */}
            <section style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              <div
                style={{
                  background: "#ffffff",
              ...
              >
                ...
                >
                  {[
                    ...
                    { equipment: "Monitor – City Engineer's Office", detail: "Intermittent flicker reported", status: "Pending", date: "Mar 09" },
                    { equipment: "Printer – City Information Office", detail: "Scheduled maintenance completed", status: "Fixed", date: "Mar 08" },
                  ].map((item) => (
                    <li
